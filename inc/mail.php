...
//$message = 'Для відновлення доступу до сторінки перейдіть за посиланням: http://ISme.club/restore.php?key='.$key.'<br/>З повагою адміністрація сайту ISme.club';

//$headers= "MIME-Version: 1.0\r\n";
//$headers .= "Content-type: text/html; charset=utf-8\r\n"; // кодировка письма
//$headers .= "From: LiveBook.com.ua <bigchopko@gmail.com>\r\n"; // от кого письмо
