...
$rats=$rat;
if($rat>=100){$rats=99;}
if($rat>10000000){$rat=10000000;}
if($limit==""){$limit=50;}
if($limit>100000000){$limit=10000000;}

    header("Content-type: image/gif");
    $im = imageCreateFromGIF("statica.gif");
 ...
 //-----------------------------------------------------------//
    ...
    imagefilledrectangle ($im, 1, 3, 1000000, 4, $color2);
    imagefilledrectangle ($im, 1, 5, 1000000, 6, $color3);
    imagefilledrectangle ($im, 1, 7, 1000000, 8, $color4);
